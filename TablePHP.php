<html> <!--47,25,95,1.0--><!--115,83,186,1.0--><!--colors in website converted to rgba-->
	<head>
		<style>
			table
			{
			...
			tr:nth-child(odd)
			{
				background-color:rgba(115,83,186,1.0);
			}
			th
			{
				border:1px rgba(0,0,0,0.2);
				padding:30px;
				background-color:rgba(47,25,95,0.7);
				border-radius:20px 5px 20px 5px;
			}
			td
			{
	...
	<body>
		<table>
			...
			<tr>
				<!--a href="http://www.irishwrecksonline.net/details/Shamrock689.htm"></a>-->
				<td>
					S.S. Shamrock II
				</td>
				<td>
